...
urlpatterns = [
    ...
    path('presences/pointer/', views.pointer_presence, name='pointer_presence'),
    path('presences/<int:presence_id>/modifier/', views.modifier_presence, name='modifier_presence'),
